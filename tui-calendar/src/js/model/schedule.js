...
function Schedule() {
    ...
    /**
     * purpose for schedule.
     * @type {string}
     */
     this.purpose = '';

     /**
     * isReturn for schedule.
     * @type {string}
     */
      this.isReturn = '';

    /**
     * carNumber for schedule.
     * @type {string}
     */
    this.carNumber = '';

     /**
     * destinationArea for schedule.
     * @type {string}
     */
...
Schedule.prototype.init = function(options) {
    ...
    this.isReturn = options.isReturn || '0';
    this.destinationArea = options.destinationArea || '';
