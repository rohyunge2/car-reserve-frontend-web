...
Time.prototype.render = function(ymd, matrices, containerHeight) {
    ...
    if ( matrices.length > 0 ) {
        for ( let matrices2 of matrices ){
            for ( let matrices3 of matrices2){
                for ( let matrices4 of matrices3 ){

                    let viewModel = matrices4;
                    if ( viewModel.model.isReturn == "1" ) {
                        viewModel.model.bgColor = "#777";
                        viewModel.model.dragBgColor = "#777";
                    }
